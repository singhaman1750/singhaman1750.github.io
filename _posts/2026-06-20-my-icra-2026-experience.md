...
I visited **ICRA 2026** in Vienna, Austria, from **1 June to 5 June**. ICRA stands for **International Conference on Robotics and Automation**. It is one of the biggest and most prestigious robotics conferences in the world. Every year, world-renowned researchers, scientists, students, and companies attend ICRA to share the latest advancements in different areas of robotics. This year, ICRA was held in **Vienna, Austria**. I was attending the conference because my paper was accepted there. The title of the paper was:

**COMPAct: Computational Optimization and Automated Design of Modular Planetary Actuators**. You can find the paper and the video here. [[Paper](https://arxiv.org/abs/2510.07197)] [[Video](https://youtu.be/etK6anjXag8?si=hRxkyNEpKuFJ-Rke)]
...
So it was not just a conference trip. It was also a small lab trip with a robotics overdose. We travelled from **Bengaluru to Vienna** through **Qatar Airways**, with a connecting flight at **Doha**. The city part of the trip deserves a separate blog, but this one is about the conference.
...
And it was literally a sea of posters. Each poster session had around **400 posters**. Four hundred posters in one session is a lot. You enter thinking, “Let me explore some interesting work.” Ten minutes later, your brain says, “We are no longer processing information. We are only walking.” The number of classical control papers felt smaller. I saw one poster where the presenter had written:

**“This paper contains no learning, if you have difficulty in understanding this, please keep walking.”**

I found that funny.

Mechanical design papers were also fewer in number, but I did find a few and made a list. You can find the list here. One area that had a lot of energy around it was **multi-fingered hands**. There was interest both in design and control. There was also a workshop on **Dexterous Manipulation using Multi-Fingered Hands**, which I attended. The number of papers on **quadruped locomotion** was lower than I expected, which was a little disheartening for me because I love quadrupeds. On the other hand, there were more papers on **humanoid locomotion**. There were also many papers on **manipulator control**. The general vibe I got was that locomotion is being treated as almost solved, while manipulation is still far from solved.
...
However, some big names were missing. There was no **Boston Dynamics**, **RAI Lab**, **Agility Robotics**, **ANYbotics**, or **Ghost Robotics**. Their absence was noticeable, and because of that, ICRA felt slightly lacking in that specific direction. Many companies were also there to recruit people. They were clearly looking for talented researchers, which was interesting to see. Since actuator design is one of my core areas of interest, I talked to several actuator companies about their products. For me, that was one of the most useful parts of the industry section.

# Presenting My Work

I had my poster presentation on the third day of the conference. Presenting a poster at ICRA is fun, slightly stressful, and useful at the same time. You stand near your work and explain the same idea multiple times, but every conversation is slightly different because every person asks questions from a different angle.

We had a few interesting conversations with fellow researchers. One positive feedback we received was about the automated design framework in our paper. People appreciated that our framework could design the actuator in an automated way. That felt good because when you work on something for a long time, you sometimes forget what is interesting about it. 
...
A glimpse of Imperial Night can be found here: [Video](https://youtu.be/bWbff0Ph_E0?si=x3Ao_Jbe0zRret6z). This is a video uploaded by Prof. Michael Milford, QUT Professor. He also attended the conference.
...
ICRA 2026 gave me a broad picture of where robotics research is currently heading. A large part of the field seems to be moving towards learning-based methods, especially end-to-end control, VLAs, and world models. At the same time, there is a lot of interest in manipulation, multi-fingered hands, and humanoid locomotion. Classical control and mechanical design felt less represented in comparison, but they were not absent. The industry section was one of the most exciting parts for me because it showed actual robotic systems, products, humanoids, quadrupeds, robotic hands, and actuator technologies. Since actuator design is one of my core interests, talking to actuator companies was especially useful.

Presenting my own work at ICRA was also meaningful. It gave me useful feedback and helped me see my research from other people’s perspectives. Overall, ICRA 2026 was a mix of research overload, robot demos, coffee, conversations, and a lot of walking. It was tiring, but definitely worth it.
